...
player1 = Player("Player1", "AI", 0.99, 0.7, 0.5)
player2 = Player("Player2", "AI", 0.99, 0.7, 0.5)
q_table = {}
...
def train(player1, player2, training_rounds):
    ...
    for x in range(training_rounds):
        game.play()
        player1.epsilon = max(0.01, player1.epsilon * 0.99996)
        player2.epsilon = max(0.01, player2.epsilon * 0.99996)
        if(game.winner == 0):
            ...
            if(player1.strategy == "AI"):
                player1.update_q_table(0)
            if(player2.strategy == "AI"):
                player2.update_q_table(0)
            #print("It's a tie!")
        game.reset()
